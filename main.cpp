...
using namespace std;
ofstream out_graph("out_graph.txt");

void create_graph(igraph_t * g, string input)
{
	int i, nVertices=40, nEdges=0, a, b, wt;
	...
	//igraph_matrix_t res;
	//igraph_matrix_init(&res,nVertices,nVertices);
...
//	string input="F:\\matlab_workspace\\pro\\output\\"+dirname+"\\"+filename;
	//string input = "E:\\VS\\Projects\\maxperm\\maxperm\\football_network.txt";-new
	string input = "E:\\VS\\Projects\\maxperm_zeroAndOne\\maxperm_zeroAndOne\\test_40_2.txt";
